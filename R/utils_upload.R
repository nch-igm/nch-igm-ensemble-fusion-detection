...
#'   database.
#' @examples
#' get_analysis_id(con, 'sample1', 'FusionMap')
...
#'   already present in the database.
#' @examples
#' upload_sample(con, 'sample1', 'subject1')
...
#'   already present in the database.
#' @examples
#' upload_analysis(con, 'sample1', 'FusionMap')
